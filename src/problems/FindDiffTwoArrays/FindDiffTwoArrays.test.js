...
import FindDiffTwoArrays from "./FindDiffTwoArrays";

test("basic_FindDiffTwoArrays", () => {
  expect(FindDiffTwoArrays.FindDiffTwoArrays([1, 2, 3], [2, 4, 6])).toEqual([
    [1, 3],
    [4, 6],
  ]);
});

test("second_FindDiffTwoArrays", () => {
  expect(
    FindDiffTwoArrays.FindDiffTwoArrays([1, 2, 3, 3], [1, 1, 2, 2])
  ).toEqual([[3], []]);
});

test("basic_FindDiffTwoArraysBetter", () => {
  expect(
    FindDiffTwoArrays.FindDiffTwoArraysBetter([1, 2, 3], [2, 4, 6])
  ).toEqual([
    [1, 3],
    [4, 6],
  ]);
...
test("second_FindDiffTwoArraysBetter", () => {
  expect(
    FindDiffTwoArrays.FindDiffTwoArraysBetter([1, 2, 3, 3], [1, 1, 2, 2])
  ).toEqual([[3], []]);
});
